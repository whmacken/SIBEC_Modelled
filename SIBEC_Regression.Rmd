...
interSI<- climSI %>% dplyr::filter(!str_detect(BGC, ("CWH|CDF|CMX|MH|MHRF|CVG|CRF|CMA|CWF|CCH|IDFww|ESSFmk"))) %>% 
  dplyr::filter(!XSI == 18, !XSI == 21,!XSI == 15 ,!XSI == 24)#, "CMX", "MH", "MHRF", "CVG", "CRF")))
...
pc <- ggplot(coastSI, aes(x = DD5, y = XSI))+
  ...
  scale_y_continuous(limit = c(0, 45))+
    ...
    ggtitle(paste0(Spp, " SI50 by DD5 in Coastal BGCs"))+
...
pi <- ggplot(interSI, aes(x = DD5, y = XSI))+
  ...
  geom_jitter(width = 0) +
 # coord_flip()+
    ggtitle(paste0(Spp, " SI50 by DD5 in Interior BGCs"))+   xlab ("DD5")+
...
#pi <- 
  ...
  scale_y_continuous(limit = c(0, 45))+
     scale_x_continuous(limit = c(0, 5000))+
    ggtitle(paste0(Spp, " climatic maximum SI50 Predicted  by DD5 in interior BGCs"))+
  geom_text (aes(label= BGC), size = 2, hjust = -.1, position = position_dodge(width=1) )+
  #geom_abline(intercept = -11, slope = .042, color = "green")+
  #geom_abline(intercept = -1.86715, slope = .0263, color = "red")+
  geom_hline(yintercept= (SppMaxSI$MaxSI), linetype="dashed", color = "red")+
...
#pc <- 
  ...
  scale_y_continuous(limit = c(0, 45))+
     scale_x_continuous(limit = c(0, 5000))+
    ggtitle(paste0(Spp, " climatic maximum SI50 Predictedby DD5 in coastal BGCs"))+
  geom_text (aes(label= BGC), size = 2, hjust = -.1, position = position_dodge(width=1) )+
  #geom_abline(intercept = -11, slope = .042, color = "green")+
  #geom_abline(intercept = -1.86715, slope = .0263, color = "red")+
  geom_hline(yintercept= (SppMaxSI$MaxSI), linetype="dashed", color = "red")+
...
#ggsave(paste0 ("./outputs/", Spp, "_coast_SIpotential_predicted.jpg"))
  ...
  scale_y_continuous(limit = c(0, 45))+
     scale_x_continuous(limit = c(0, 5000))+
    ggtitle(paste0(Spp, " climatic maximum SI50 Predictedby DD5 in all BGCs"))+
  geom_text (aes(label= BGC), size = 2, hjust = -.1, position = position_dodge(width=1) )+
  #geom_abline(intercept = -11, slope = .042, color = "green")+
  #geom_abline(intercept = -1.86715, slope = .0263, color = "red")+
  geom_hline(yintercept= (SppMaxSI$MaxSI), linetype="dashed", color = "red")+
...
write.csv(SIbySS, paste0("./outputs/", Spp, "_estimated_potential_SI.csv"))
```
